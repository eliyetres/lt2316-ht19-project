...
from config import BATCH_SIZE, EMBEDDING_SIZE, HIDDEN_SIZE, EPOCHS, DEVICE, N_LAYERS, LEARNING_RATE, SOS_TOKEN, EOS_TOKEN,ENC_DROPOUT,DEC_DROPOUT
...
#device, input_dim, emb_dim, pretrained_vec, hidden_dim, n_layers, dropout
...
#device, embedding_dim, pretrained_vec, hidden_dim,output_dim, n_layers, dropout
decoder = Decoder(
	device=device,
